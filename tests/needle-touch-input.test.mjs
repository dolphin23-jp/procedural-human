...
test(
  'TASK-070 touch/Pencil adapter accepts touch and pen pointer input without pressure dependency',
  () => {
...
test(
  'TASK-070 keeps browser input normalized and outside instrument medical state',
  () => {
    ...
    assert.doesNotMatch(
      touchAdapter,
      /NeedleInstance|PatientState|SpatialQuery|procedure/i,
    );
  },
);

test(
  'TASK-070 exposes iPad-sized mode controls for move, rotate, and advance',
  () => {
