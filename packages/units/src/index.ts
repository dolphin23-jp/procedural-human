...
type Quantity<Kind extends string> = number & { readonly [quantityBrand]: Kind };
...
export const degrees = (value: number): Angle => cast<Angle>((value * Math.PI) / 180);
...
export const kilopascals = (value: number): Pressure => cast<Pressure>(value * 1_000);
...
export const toMillimetresOfMercury = (value: Pressure): number => value / PASCALS_PER_MMHG;

export const millimetresPerSecond = (value: number): Velocity => cast<Velocity>(value);
export const metresPerSecond = (value: number): Velocity => cast<Velocity>(value * 1_000);
...
export const cubicMillimetresPerSecond = (value: number): FlowRate => cast<FlowRate>(value);
export const millilitresPerSecond = (value: number): FlowRate => cast<FlowRate>(value * 1_000);
export const litresPerMinute = (value: number): FlowRate => cast<FlowRate>((value * 1_000_000) / 60);
export const toCubicMillimetresPerSecond = (value: FlowRate): number => value;
export const toMillilitresPerSecond = (value: FlowRate): number => value / 1_000;
export const toLitresPerMinute = (value: FlowRate): number => (value * 60) / 1_000_000;

export const cubicMillimetres = (value: number): Volume => cast<Volume>(value);
export const millilitres = (value: number): Volume => cast<Volume>(value * 1_000);
export const litres = (value: number): Volume => cast<Volume>(value * 1_000_000);
...
export const millinewtons = (value: number): Force => cast<Force>(value / 1_000);
